...
- [ ] **Phase 1: Foundation and ATP Data Contracts** - Establish the typed project, Sackmann source lineage, ATP-only scope rules, and canonical data tables.
...
Plans:
- [ ] 02-01: Chronological feature runner and feature snapshot contracts
- [ ] 02-02: Elo, ranking, recent-form, and rest features
- [ ] 02-03: Serve/return, H2H, context, and differential features
- [ ] 02-04: Leakage test suite and feature persistence gate
...
Plans:
- [ ] 03-01: Chronological dataset builder and split manifests
- [ ] 03-02: Baseline model training for logistic regression and random forest
- [ ] 03-03: XGBoost candidate, probability calibration, and metric reports
- [ ] 03-04: Artifact registry and segment diagnostics
...
|-------|----------------|--------|-----------|
| 1. Foundation and ATP Data Contracts | 0/4 | Not started | - |
| 2. Leakage-Safe Feature Engine | 0/4 | Not started | - |
