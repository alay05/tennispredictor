...
def ingest_snapshot(
    *,
    ...
    return persist_canonical_snapshot(
        canonical_snapshot,
...
def run_backtest(
    *,
    ...
    thresholds = DecisionThresholds(
        ...
        min_liquidity=(
            min_liquidity if min_liquidity is not None else resolved_settings.default_min_liquidity
        ),
...
def collect_kalshi_snapshots(
    *,
    ...
    try:
        return collect_kalshi_snapshot_job(
            client,
            database_path=_database_path(database_path, settings=resolved_settings),
...
def scan_kalshi_ev(
    *,
    ...
    result = run_kalshi_ev_scan(
        ...
        run_id=run_id or resolved_settings.default_monitoring_run_id,
